...
ActiveRecord::Schema.define(version: 2018_01_25_154506) do
  ...
  create_table "elections_voters", id: false, force: :cascade do |t|
    ...
    t.index ["election_id", "voter_id"], name: "index_elections_voters_on_election_id_and_voter_id"
    t.index ["voter_id", "election_id"], name: "index_elections_voters_on_voter_id_and_election_id"
  end
